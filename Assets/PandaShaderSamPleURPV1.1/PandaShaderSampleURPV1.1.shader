...
Shader "VFX/PandaShaderSampleURPV1.1"
{
    Properties
    {
        ...
        [ASEEnd][Toggle]_RefactionMaskTexUVClip("RefactionMaskTexUVClip", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Tags
            {
                "LightMode"="PandaPass" "Queue"="Overlay"
            }
            ...
            float UVClamp21_g149(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
                {
            ...
            float CustomChanelSwitch5_g148(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
                    F = 0;
            ...
            float UVClamp21_g150(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
            ...
            half4 frag(VertexOutput IN) : SV_Target
            {
                ...
                float2 rotator38_g149 = mul(uv_RefactionTex - float2(0.5, 0.5),
                                            float2x2(cos38_g149, -sin38_g149, sin38_g149, cos38_g149)) + float2(
                    0.5, 0.5);
                ...
                float F21_g149 = 0.0;
                float localUVClamp21_g149 = UVClamp21_g149(UVClip21_g149, UClamp21_g149, VClamp21_g149, UMirror21_g149,
                                                           VMirror21_g149, U21_g149, V21_g149, F21_g149);
                float2 appendResult44_g149 = (float2(U21_g149, V21_g149));
                float4 tex2DNode7_g149 = tex2D(_RefactionTex, appendResult44_g149);
                float temp_output_739_20 = (F21_g149 * (
                    _RefactionTexAR == 0.0 ? tex2DNode7_g149.a : tex2DNode7_g149.r));
                ...
                float F5_g148 = 0.0;
                float localCustomChanelSwitch5_g148 = CustomChanelSwitch5_g148(
                    Num5_g148, c1x5_g148, c1y5_g148, c1z5_g148, c1w5_g148, c2x5_g148, c2y5_g148, c2z5_g148, c2w5_g148,
                    F5_g148);
                ...
                float2 rotator38_g150 = mul(uv_RefactionMaskTex - float2(0.5, 0.5),
                                            float2x2(cos38_g150, -sin38_g150, sin38_g150, cos38_g150)) + float2(
                    0.5, 0.5);
                ...
                float F21_g150 = 0.0;
                float localUVClamp21_g150 = UVClamp21_g150(UVClip21_g150, UClamp21_g150, VClamp21_g150, UMirror21_g150,
                                                           VMirror21_g150, U21_g150, V21_g150, F21_g150);
                ...
                float staticSwitch781 = (F21_g150 * (
                    _RefactionMaskTexAR == 0.0 ? tex2DNode7_g150.a : tex2DNode7_g150.r));
                #else
				float staticSwitch781 = 1.0;
                #endif
                #ifdef _IFREFACTION_ON
                float4 staticSwitch726 = tex2D(_PandaGrabTex,
                                               (ase_grabScreenPosNorm + (((_RefactionRemap)
                                                                              ? ((-0.5 + (temp_output_739_20 - 0.0) * (
                                                                                  0.5 - -0.5) / (1.0 - 0.0)))
                                                                              : (temp_output_739_20)) * (
                                                   (_CustomRefactionFactor)
                                                       ? ((F5_g148 * 0.2))
                                                       : ((_RefactionFactor * 0.2))) * staticSwitch781)).xy);
                #else
        ...
        Pass
        {
            ...
            Tags
            {
                "LightMode"="UniversalForwardOnly" "Queue"="Transparent"
            }
            ...
            float UVClamp21_g144(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
            ...
            float CustomChanelSwitch5_g117(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float UVClamp21_g146(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
            ...
            float CustomChanelSwitch5_g147(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float CustomChanelSwitch5_g119(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float CustomChanelSwitch5_g118(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float UVClamp21_g143(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
            ...
            float CustomChanelSwitch5_g107(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float CustomChanelSwitch5_g105(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float CustomChanelSwitch5_g102(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float UVClamp21_g140(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
            ...
            float CustomChanelSwitch5_g104(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float CustomChanelSwitch5_g103(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float UVClamp21_g139(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
            ...
            float CustomChanelSwitch5_g113(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float CustomChanelSwitch5_g114(float Num, float c1x, float c1y, float c1z, float c1w, float c2x, float c2y,
                                           float c2z, float c2w, out float F)
            {
                if (Num == 0)
                {
            ...
            float UVClamp21_g142(float UVClip, float UClamp, float VClamp, float UMirror, float VMirror, inout float U,
                                 inout float V, out float F)
            {
                F = 1;
                if (UMirror == 1)
            ...
            VertexOutput VertexFunction(VertexInput v)
            {
                ...
                float2 rotator38_g144 = mul(uv_VTOTex - float2(0.5, 0.5),
                                            float2x2(cos38_g144, -sin38_g144, sin38_g144, cos38_g144)) + float2(
                    0.5, 0.5);
                ...
                float F21_g144 = 0.0;
                float localUVClamp21_g144 = UVClamp21_g144(UVClip21_g144, UClamp21_g144, VClamp21_g144, UMirror21_g144,
                                                           VMirror21_g144, U21_g144, V21_g144, F21_g144);
                ...
                float F5_g117 = 0.0;
                float localCustomChanelSwitch5_g117 = CustomChanelSwitch5_g117(
                    Num5_g117, c1x5_g117, c1y5_g117, c1z5_g117, c1w5_g117, c2x5_g117, c2y5_g117, c2z5_g117, c2w5_g117,
                    F5_g117);
                float3 VTO387 = (v.ase_normal * (F21_g144 * (_VTOTexAR == 0.0 ? tex2DNode7_g144.a : tex2DNode7_g144.r))
                    * ((_CustomVTO) ? (F5_g117) : (_VTOScale)));
                #ifdef _IFVTO_ON
            ...
            half4 frag(VertexOutput IN) : SV_Target
            {
                ...
                float2 rotator38_g146 = mul(uv_DistortTex - float2(0.5, 0.5),
                                            float2x2(cos38_g146, -sin38_g146, sin38_g146, cos38_g146)) + float2(
                    0.5, 0.5);
                ...
                float F21_g146 = 0.0;
                float localUVClamp21_g146 = UVClamp21_g146(UVClip21_g146, UClamp21_g146, VClamp21_g146, UMirror21_g146,
                                                           VMirror21_g146, U21_g146, V21_g146, F21_g146);
                ...
                float F5_g147 = 0.0;
                float localCustomChanelSwitch5_g147 = CustomChanelSwitch5_g147(
                    Num5_g147, c1x5_g147, c1y5_g147, c1z5_g147, c1w5_g147, c2x5_g147, c2y5_g147, c2z5_g147, c2w5_g147,
                    F5_g147);
                float2 appendResult465 = (float2(_DistortUIntensity, _DistortVIntensity));
                float2 Distort148 = (((_DistortRemap)
                                          ? ((-0.5 + (temp_output_675_20 - 0.0) * (0.5 - -0.5) / (1.0 - 0.0)))
                                          : (temp_output_675_20)) * ((_CustomDistortFactor)
                                                                         ? (F5_g147)
                                                                         : (_DistortFactor)) * appendResult465);
                #ifdef _FDISTORTTEX_ON
                float2 staticSwitch316 = (_DistortMainTex == 0.0
                                              ? temp_output_3_0_g145
                                              : (temp_output_3_0_g145 + Distort148));
                #else
                ...
                float F5_g119 = 0.0;
                float localCustomChanelSwitch5_g119 = CustomChanelSwitch5_g119(
                    Num5_g119, c1x5_g119, c1y5_g119, c1z5_g119, c1w5_g119, c2x5_g119, c2y5_g119, c2z5_g119, c2w5_g119,
                    F5_g119);
                ...
                float F5_g118 = 0.0;
                float localCustomChanelSwitch5_g118 = CustomChanelSwitch5_g118(
                    Num5_g118, c1x5_g118, c1y5_g118, c1z5_g118, c1w5_g118, c2x5_g118, c2y5_g118, c2z5_g118, c2w5_g118,
                    F5_g118);
                float2 appendResult330 = (float2(((_CustomMainTexUOffset) ? (F5_g119) : (0.0)),
                                                 ((_CustomMainTexVOffset) ? (F5_g118) : (0.0))));
                float cos38_g143 = cos((_MainTexRotator * (2.0 * PI)));
                float sin38_g143 = sin((_MainTexRotator * (2.0 * PI)));
                float2 rotator38_g143 = mul((staticSwitch316 + appendResult330) - float2(0.5, 0.5),
                                            float2x2(cos38_g143, -sin38_g143, sin38_g143, cos38_g143)) + float2(
                    0.5, 0.5);
                ...
                float F21_g143 = 0.0;
                float localUVClamp21_g143 = UVClamp21_g143(UVClip21_g143, UClamp21_g143, VClamp21_g143, UMirror21_g143,
                                                           VMirror21_g143, U21_g143, V21_g143, F21_g143);
                ...
                float3 appendResult51_g143 = (float3(tex2D(_MainTex, (appendResult44_g143 + temp_output_48_0_g143)).r,
                                                     tex2DNode7_g143.g,
                                                     tex2D(_MainTex, (appendResult44_g143 - temp_cast_0)).b));
                ...
                float lerpResult34_g143 = lerp((break30_g143.x * desaturateVar27_g143.x),
                                               (break30_g143.y * pow(desaturateVar27_g143.x, break30_g143.z)),
                                               break30_g143.w);
                ...
                float3 desaturateVar36_g143 = lerp(desaturateInitialColor36_g143, desaturateDot36_g143.xxx,
                                                   _MainTexDesaturate);
                ...
                float F5_g107 = 0.0;
                float localCustomChanelSwitch5_g107 = CustomChanelSwitch5_g107(
                    Num5_g107, c1x5_g107, c1y5_g107, c1z5_g107, c1w5_g107, c2x5_g107, c2y5_g107, c2z5_g107, c2w5_g107,
                    F5_g107);
                float temp_output_275_0 = (-_DissolveWide + (((_CustomDissolve) ? (F5_g107) : (_DissolveFactor)) - 0.0)
                    * (1.0 - -_DissolveWide) / (1.0 - 0.0));
                float temp_output_277_0 = (_DissolveSoft + 0.0001);
                float temp_output_272_0 = (-temp_output_277_0 + ((temp_output_275_0 + _DissolveWide) - 0.0) * (1.0 - -
                    temp_output_277_0) / (1.0 - 0.0));
                ...
                #ifdef _FDISTORTTEX_ON
                float2 staticSwitch314 = (_DistortDissolveTex == 0.0
                                              ? temp_output_3_0_g106
                                              : (temp_output_3_0_g106 + Distort148));
                #else
                ...
                float F5_g105 = 0.0;
                float localCustomChanelSwitch5_g105 = CustomChanelSwitch5_g105(
                    Num5_g105, c1x5_g105, c1y5_g105, c1z5_g105, c1w5_g105, c2x5_g105, c2y5_g105, c2z5_g105, c2w5_g105,
                    F5_g105);
                ...
                float F5_g102 = 0.0;
                float localCustomChanelSwitch5_g102 = CustomChanelSwitch5_g102(
                    Num5_g102, c1x5_g102, c1y5_g102, c1z5_g102, c1w5_g102, c2x5_g102, c2y5_g102, c2z5_g102, c2w5_g102,
                    F5_g102);
                float2 appendResult479 = (float2(((_CustomDissolveTexUOffset) ? (F5_g105) : (0.0)),
                                                 ((_CustomDissolveTexVOffset) ? (F5_g102) : (0.0))));
                float cos38_g140 = cos((_DissolveTexRotator * (2.0 * PI)));
                float sin38_g140 = sin((_DissolveTexRotator * (2.0 * PI)));
                float2 rotator38_g140 = mul((staticSwitch314 + appendResult479) - float2(0.5, 0.5),
                                            float2x2(cos38_g140, -sin38_g140, sin38_g140, cos38_g140)) + float2(
                    0.5, 0.5);
                ...
                float F21_g140 = 0.0;
                float localUVClamp21_g140 = UVClamp21_g140(UVClip21_g140, UClamp21_g140, VClamp21_g140, UMirror21_g140,
                                                           VMirror21_g140, U21_g140, V21_g140, F21_g140);
                ...
                float F5_g104 = 0.0;
                float localCustomChanelSwitch5_g104 = CustomChanelSwitch5_g104(
                    Num5_g104, c1x5_g104, c1y5_g104, c1z5_g104, c1w5_g104, c2x5_g104, c2y5_g104, c2z5_g104, c2w5_g104,
                    F5_g104);
                ...
                float F5_g103 = 0.0;
                float localCustomChanelSwitch5_g103 = CustomChanelSwitch5_g103(
                    Num5_g103, c1x5_g103, c1y5_g103, c1z5_g103, c1w5_g103, c2x5_g103, c2y5_g103, c2z5_g103, c2w5_g103,
                    F5_g103);
                float2 appendResult497 = (float2(((_CustomDissolvePlusTexUOffset) ? (F5_g104) : (0.0)),
                                                 ((_CustomDissolvePlusTexVOffset) ? (F5_g103) : (0.0))));
                float cos38_g139 = cos((_DissolvePlusTexRotator * (2.0 * PI)));
                float sin38_g139 = sin((_DissolvePlusTexRotator * (2.0 * PI)));
                float2 rotator38_g139 = mul((uv_DissolvePlusTex + appendResult497) - float2(0.5, 0.5),
                                            float2x2(cos38_g139, -sin38_g139, sin38_g139, cos38_g139)) + float2(
                    0.5, 0.5);
                ...
                float F21_g139 = 0.0;
                float localUVClamp21_g139 = UVClamp21_g139(UVClip21_g139, UClamp21_g139, VClamp21_g139, UMirror21_g139,
                                                           VMirror21_g139, U21_g139, V21_g139, F21_g139);
                float2 appendResult44_g139 = (float2(U21_g139, V21_g139));
                float4 tex2DNode7_g139 = tex2D(_DissolvePlusTex, appendResult44_g139);
                float lerpResult413 = lerp(temp_output_677_20,
                                           (F21_g139 * (_DissolvePlusTexAR == 0.0
                                                            ? tex2DNode7_g139.a
                                                            : tex2DNode7_g139.r)), _DissolvePlusIntensity);
                #ifdef _FDISSOLVEPLUSTEX_ON
                float staticSwitch415 = lerpResult413;
                #else
				float staticSwitch415 = temp_output_677_20;
                #endif
                float smoothstepResult264 = smoothstep(temp_output_272_0, (temp_output_272_0 + temp_output_277_0),
                                                       staticSwitch415);
                float Alpha337 = _MainAlpha;
                float4 lerpResult223 = lerp(MainTexColor215, _DissolveColor,
                                            (_DissolveColor.a * (1.0 - smoothstepResult264) * Alpha337));
                ...
                float MainTexAlpha138 = (_MainColor.a * (F21_g143 * (_MainTexAR == 0.0
                                                                         ? tex2DNode7_g143.a
                                                                         : tex2DNode7_g143.r)));
                ...
                #ifdef _FDISTORTTEX_ON
                float2 staticSwitch312 = (_DistortMaskTex == 0.0
                                              ? temp_output_3_0_g115
                                              : (temp_output_3_0_g115 + Distort148));
                #else
                ...
                float F5_g113 = 0.0;
                float localCustomChanelSwitch5_g113 = CustomChanelSwitch5_g113(
                    Num5_g113, c1x5_g113, c1y5_g113, c1z5_g113, c1w5_g113, c2x5_g113, c2y5_g113, c2z5_g113, c2w5_g113,
                    F5_g113);
                ...
                float F5_g114 = 0.0;
                float localCustomChanelSwitch5_g114 = CustomChanelSwitch5_g114(
                    Num5_g114, c1x5_g114, c1y5_g114, c1z5_g114, c1w5_g114, c2x5_g114, c2y5_g114, c2z5_g114, c2w5_g114,
                    F5_g114);
                float2 appendResult446 = (float2(((_CustomMaskTexUOffset) ? (F5_g113) : (0.0)),
                                                 ((_CustomMaskTexVOffset) ? (F5_g114) : (0.0))));
                float cos38_g142 = cos((_MaskTexRotator * (2.0 * PI)));
                float sin38_g142 = sin((_MaskTexRotator * (2.0 * PI)));
                float2 rotator38_g142 = mul((staticSwitch312 + appendResult446) - float2(0.5, 0.5),
                                            float2x2(cos38_g142, -sin38_g142, sin38_g142, cos38_g142)) + float2(
                    0.5, 0.5);
                ...
                float F21_g142 = 0.0;
                float localUVClamp21_g142 = UVClamp21_g142(UVClip21_g142, UClamp21_g142, VClamp21_g142, UMirror21_g142,
                                                           VMirror21_g142, U21_g142, V21_g142, F21_g142);
                ...
                #endif
                float temp_output_270_0 = (-temp_output_277_0 + (temp_output_275_0 - 0.0) * (1.0 - -temp_output_277_0) /
                    (1.0 - 0.0));
                float smoothstepResult256 = smoothstep(temp_output_270_0, (temp_output_270_0 + temp_output_277_0),
                                                       staticSwitch415);
                ...
                float screenDepth375 = LinearEyeDepth(
                    SHADERGRAPH_SAMPLE_SCENE_DEPTH(ase_screenPosNorm.xy), _ZBufferParams);
                float distanceDepth375 = abs(
                    (screenDepth375 - LinearEyeDepth(ase_screenPosNorm.z, _ZBufferParams)) / (_DepthFade));
                #ifdef _FDEPTH_ON
                float staticSwitch378 = saturate(distanceDepth375);
                #else
				float staticSwitch378 = 1.0;
                #endif
                float MainAlpha97 = saturate(
                    (MainTexAlpha138 * staticSwitch291 * IN.ase_color.a * Alpha337 * staticSwitch299 * staticSwitch319 *
                        staticSwitch378));
