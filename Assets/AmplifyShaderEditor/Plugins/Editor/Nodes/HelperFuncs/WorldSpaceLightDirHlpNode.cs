...
namespace AmplifyShaderEditor
{
    ...
    public sealed class WorldSpaceLightDirHlpNode : HelperParentNode
    {
        ...
        [SerializeField] private bool m_safeNormalize = false;
            ...
            bool ignoreLocalvar)
        {
            if (dataCollector.IsTemplate)
                return GetOutputVectorItem(0, outputId,
                    dataCollector.TemplateDataCollectorInstance.GetWorldSpaceLightDir(CurrentPrecisionType));
            ;
            ...
            return GetOutputVectorItem(0, outputId,
                GeneratorUtils.GenerateWorldLightDirection(ref dataCollector, UniqueId, CurrentPrecisionType));
        }
