...
namespace AmplifyShaderEditor
{
    ...
    {
        [SerializeField] protected string m_funcType = string.Empty;

        [SerializeField] protected string m_funcLWFormatOverride = string.Empty;

        [SerializeField] protected string m_funcHDFormatOverride = string.Empty;
            ...
            bool ignoreLocalvar)
        {
            ...
            if (dataCollector.IsTemplate)
            {
                if (dataCollector.TemplateDataCollectorInstance.CurrentSRPType == TemplateSRPType.Lightweight &&
                    !string.IsNullOrEmpty(m_funcLWFormatOverride))
                {
                    finalResult = string.Format(m_funcLWFormatOverride, concatResults);
                         ...
                         !string.IsNullOrEmpty(m_funcHDFormatOverride))
                {
