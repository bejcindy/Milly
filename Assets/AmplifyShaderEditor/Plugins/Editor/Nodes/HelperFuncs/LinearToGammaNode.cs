...
namespace AmplifyShaderEditor
{
    ...
    public sealed class LinearToGammaNode : HelperParentNode
    {
        ...
        public readonly static string[] ModeListStrLW =
            { "Fast Linear to sRGB", "Exact Linear to sRGB", "Linear to Gamma 2.0", "Linear to Gamma 2.2" };

        public readonly static int[] ModeListIntLW = { 0, 1, 2, 3 };

        [SerializeField] public int m_selectedMode = 0;
            ...
            if (!dataCollector.IsSRP)
            {
                ...
                if (m_selectedMode == 1)
                {
                    ...
                    dataCollector.AddLocalVariable(UniqueId,
                        m_localVarName + " = half3( LinearToGammaSpaceExact(" + m_localVarName +
                        ".r), LinearToGammaSpaceExact(" + m_localVarName + ".g), LinearToGammaSpaceExact(" +
                        m_localVarName + ".b) );");
