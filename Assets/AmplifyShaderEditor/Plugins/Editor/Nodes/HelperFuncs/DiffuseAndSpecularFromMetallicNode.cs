...
namespace AmplifyShaderEditor
{
    ...
    public class DiffuseAndSpecularFromMetallicNode : ParentNode
    {
            ...
            bool ignoreLocalvar)
        {
            ...
            dataCollector.AddLocalVariable(UniqueId, PrecisionType.Half, WirePortDataType.FLOAT3, specColorVar,
                "(0).xxx");
            dataCollector.AddLocalVariable(UniqueId, PrecisionType.Half, WirePortDataType.FLOAT,
                oneMinusReflectivityVar, "0");
