	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float clampResult141 = clamp( (0.0 + (pow( ( ( Clip_BeforeStep177 / _GradientScale ) + _GradientOffset ) , _GradientPower ) - 0.0) * (1.0 - 0.0) / (RemappedHeight132 - 0.0)) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18912
13.33333;774;2558.667;1363.667;2770.294;1142.719;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-2337.393,-51.92191;Inherit;False;Property;_WobbleX;WobbleX;13;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;1.164187E-23;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;184;-1068.811,329.2708;Inherit;False;Property;_Liveness;Liveness;0;1;[Header];Create;True;2;__Liquid__;for lerp animation;0;0;False;0;False;0;0.9917041;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-1491.251,-627.7589;Inherit;False;Property;_LiquidHeight;LiquidHeight;1;1;[Header];Create;True;1;Liquid;0;0;False;0;False;0;0.924;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;113;-1421.981,-540.0466;Inherit;False;Property;_HeightRemap;HeightRemap;5;1;[Header];Create;True;1;Align Gradient Color with position;0;0;False;0;False;0,1,2.2,-1.3;0,1,1.09,-0.04;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;148;-2277.43,1794.16;Inherit;False;Property;_GradientPower;GradientPower;8;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;139;-2699.188,1799.849;Inherit;False;Property;_GradientScale;GradientScale;6;0;Create;True;0;0;0;False;0;False;1;1.78;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;137;-1356.82,1590.913;Inherit;False;Property;_Color_Bot;Color_Bot;4;0;Create;True;1;Gradient;0;0;False;0;False;0,0.3777804,1,1;0.2420569,0.1490196,0.3294117,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2487.037,1796.633;Inherit;False;Property;_GradientOffset;GradientOffset;7;0;Create;True;0;0;0;False;0;False;0;0.35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;142;-2364.3,1671.924;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;149;-2047.307,1805.539;Inherit;False;132;RemappedHeight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;81;-1531.443,-1100.709;Inherit;False;Property;_LiquidSurfaceColor;LiquidSurfaceColor;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.3725189,0.2437403,0.490566,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;136;-1358.834,1422.008;Inherit;False;Property;_Color_Top;Color_Top;3;1;[Header];Create;True;1;Gradient;0;0;False;0;False;0.06289297,0.9679592,1,1;0.6494825,0.8018868,0.4190993,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=64418E85476C02C34C4A4EA1B6C5875D4033B060