...
{
    [Serializable]
    [NodeAttributes("Shade Vertex Lights", "Light",
    ...
    public sealed class ShadeVertexLightsHlpNode : ParentNode
    {
        ...
        [SerializeField] private int m_lightCount = 4;

        [SerializeField] private bool m_enableSpotlight = false;
            ...
            bool ignoreLocalvar)
        {
            ...
            string value = string.Format(ShadeVertexLightFunc, vertexPosition, vertexNormal, m_lightCount,
                m_enableSpotlight.ToString().ToLower());
